  ...
  >
    <div class="container flex flex-wrap justify-between items-center mx-auto">
      ...
      <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
        ...
        >
          <li @click="onApplicantsClick" v-if="checkMenubar('applicants')">
            <a
              href="#"
              class="block py-2 pr-4 pl-3 text-white bg-blue-700 text-gray-700 rounded md:bg-transparent md:p-0 dark:text-white"
              aria-current="page"
              >All Applications</a
            >
          </li>
          <li @click="onApplicationsClick" v-if="checkMenubar('applications')">
            <a
              href="#"
          ...
          <li @click="onNewPositionClick" v-if="checkMenubar('newPosition')">
            <a
              href="#"
              class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
              >Add Position</a
