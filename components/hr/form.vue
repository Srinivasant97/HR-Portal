...
export default {
  ...
  methods: {
    async submitForm() {
      let job_app = {
        job_app_title: this.job_app_title,
        job_app_location: this.job_app_location,
